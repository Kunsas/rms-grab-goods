package com.kunsas.grabgoods.categoryservice.constant.client;
...
public class ProductConstants {
    ...
    public static final String INVALID_PRODUCT_PRICE_MESSAGE = "Invalid Product price.Product Price must be greater than or equal to zero. Allowed up to 2 decimal places and currency symbols ($,₹,€,£).";
