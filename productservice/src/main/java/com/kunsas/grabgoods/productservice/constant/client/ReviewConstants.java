package com.kunsas.grabgoods.productservice.constant.client;
...
public class ReviewConstants {
    ...
    public static final String INVALID_REVIEW_TITLE_MESSAGE = "Review title must have length of min 1 and max 68, no special characters allowed except space";
    ...
    public static final String REVIEW_TITLE_REGEX = "^[a-zA-Z\\s]+$";
